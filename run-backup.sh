...
PGPASSWORD="$POSTGRES_ENV_POSTGRES_PASSWORD" pg_dump -h "$POSTGRES_PORT_5432_TCP_ADDR" -U "$POSTGRES_ENV_POSTGRES_USER" $DUMP_OPTIONS "$POSTGRES_ENV_POSTGRES_DB" > $FILE
